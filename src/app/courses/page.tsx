    ...
    return (
        <div>
            ...
            <section className="mx-auto max-w-6xl px-4 py-16">
                ...
                <div className="mb-16">
                    <div className="inline-block px-3 py-1 rounded-full text-xs font-semibold bg-[color:var(--accent)]/10 text-[color:var(--primary)] dark:text-[color:var(--accent)] mb-3">
                        UG Programs
                    </div>
                    ...
                    <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                        {undergrad.map((course) => (
                            <Card key={course.id} className="hover:-translate-y-1 transition-transform border-t-4 border-t-[color:var(--primary)] shadow-sm flex flex-col">
                                <CardHeader className="pb-2">
                                    {course.department && (
                                        <Badge className="self-start mb-2 bg-[color:var(--primary)]/10 text-[color:var(--primary)] dark:text-[color:var(--accent)] border-none">
                                            {course.department}
                                        </Badge>
                                    )}
                                ...
                                <CardContent className="flex-1 flex flex-col gap-4">
                                    ...
                                    <Button href="/admissions" className="bg-[color:var(--primary)] text-white hover:bg-[color:var(--primary)]/90 w-full text-center mt-2">
                                        Apply Now
                                    </Button>
                                </CardContent>
                            </Card>
                ...
                {postgrad.length > 0 && (
                    <div className="mb-16">
                        ...
                        <div className="flex items-end justify-between mb-8">
                            <h2 className="text-3xl font-bold tracking-tight">Postgraduate Programs</h2>
                        </div>
                        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                            {postgrad.map((course) => (
                                <Card key={course.id} className="hover:-translate-y-1 transition-transform border-t-4 border-t-[color:var(--accent)] shadow-sm flex flex-col">
                                    <CardHeader className="pb-2">
                                        {course.department && (
                                            <Badge className="self-start mb-2 bg-[color:var(--accent)]/10 text-[color:var(--primary)] dark:text-[color:var(--accent)] border-none">
                                                {course.department}
                                            </Badge>
                                        )}
                                        <CardTitle className="text-lg">{course.name}</CardTitle>
                                    ...
                                    <CardContent className="flex-1 flex flex-col gap-4">
                                        ...
                                        <Button href="/admissions" className="bg-[color:var(--accent)] text-[color:var(--primary)] hover:bg-[color:var(--accent)]/90 w-full text-center mt-2 font-bold">
                                            Apply Now
                                        </Button>
                                    </CardContent>
                                </Card>
                ...
                {/* CTA */}
                <div className="rounded-2xl bg-[color:var(--primary)] p-8 md:p-12 text-white text-center">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Button href="/admissions" className="bg-[color:var(--accent)] text-[color:var(--primary)] font-bold border-none">Apply Now</Button>
